...
| Ситуация | Поведение |
|----------|-----------|
| Неразрешимый идентификатор пресета | Пустая болванка: идентификатор сохранён, состав пуст, имени, иконки и категории нет. Любой запрос свойства даёт `null`. Решение о судьбе предмета принимает держатель коллекции |
...
| Неразрешимый ключ категории | `Category` возвращает `null`, ошибка в лог |
