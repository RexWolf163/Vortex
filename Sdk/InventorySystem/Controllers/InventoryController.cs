...
namespace Vortex.Sdk.InventorySystem.Controllers
{
    ...
    public static class InventoryController
    {
        ...
        /// политике инвентаря и поднимает событие состава.
        /// </summary>
        ...
        /// задаёт ей полное количество и прогоняет через набор верификаторов
        ...
        ///
        /// Точность держится на том, что вердикт верификатора зависит от количества единиц, а не от
        /// числа пачек: <see cref="AddCount"/> разложит то же количество на несколько пачек, а проба
        /// проверяет одной. Все текущие верификаторы этому удовлетворяют (сумма массы/объёма, фильтры
