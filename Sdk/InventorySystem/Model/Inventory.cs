...
namespace Vortex.Sdk.InventorySystem.Model
{
    ...
    public class Inventory
    {
        ...
        /// <summary>
        /// Наложить настройку (верификаторы и политику пачек) из шаблона. Настройка — поля, не свойства,
        /// поэтому в сейв не идёт: на загрузке восстанавливается только состав, а правила приходят пустыми.
        /// Этот метод накладывает их заново из настроечного ассета на восстановленный состав — состав при
        /// этом не трогается. Стартовое наполнение переносить не нужно: на загрузке состав уже из сейва.
        /// </summary>
        public void AdoptConfig(Inventory template)
        {
            if (template == null)
                return;
