...
| `CanAdd(presetGuid, n)` | Влезет ли `n` единиц — тихой пробой (без создания предмета и события) по верификаторам |
...
| `OnItemChanged` | У предмета в составе изменилось содержимое — количество, распад, добавленное/убранное свойство |
