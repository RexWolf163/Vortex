...
- **Проверка модуля** — окно `Tools/Vortex/GlobalData/Index` (Unity SaveSystem): вне Play Mode покажет модуль, его ключ и проблемы, из-за которых хранилище его пропустит; в Play Mode — текущие значения с правкой на лету.
