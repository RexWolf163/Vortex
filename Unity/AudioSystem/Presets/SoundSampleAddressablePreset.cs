...
{
    [CreateAssetMenu(fileName = "Sound", menuName = "Database/SoundSampleAddressable")]
    public class SoundSampleAddressablePreset : RecordPreset<Sound>
    {
        [SerializeField] private AssetReferenceAudioClip[] audioClips;
